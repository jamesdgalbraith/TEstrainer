...
parallel --bar --jobs ${THREADS} -a ${DATA_DIR}/trf/split/${RM_LIBRARY}_split.txt cat ${DATA_DIR}/trf/split/{}.trf.tsv ">>" ${DATA_DIR}/trf/${RM_LIBRARY}.trf
# Running SA-SSR
echo "Running SA-SSR"
...
parallel --bar --jobs 1 -a ${DATA_DIR}/trf/split/${RM_LIBRARY}_split.txt cat ${DATA_DIR}/trf/split/{} >> ${DATA_DIR}/trf/${RM_LIBRARY}.mreps
